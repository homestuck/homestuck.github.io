export default function Home() {
  return (
    <main className='min-w-4xl bg-primary max-w-4xl w-fit flex flex-col items-center py-4 font-sans'>
      <article className='bg-background flex flex-col gap-4 justify-center min-w-lg max-w-lg w-fit *:not-first:px-6 *:last:pb-8'>
        <header className='bg-muted border-b-4 p-4 border-b-primary'>
